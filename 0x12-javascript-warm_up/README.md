...
This project marks my initial foray into JavaScript at [ALX](https://alx_africa.com). It involved writing introductory-level JavaScript scripts on Node.js.

## Tests

* [tests](./tests): Contains test files provided by ALX.
